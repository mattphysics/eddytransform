...
if kind == 'anticyclonic':
    ...
    fname_root = fname_root_dir + 'eddy_'
elif kind == 'cyclonic':
...
# ds = xr.open_mfdataset('/ec/fws5/lb/project/eerie/data/GPM_IMERG/*daily*.nc',combine='nested',concat_dim='time')
ds = xr.open_zarr('/ec/fws5/lb/project/eerie/data/surface_wind/surface_wind_0125.zarr')
# winds = xr.open_zarr('/ec/fws5/lb/project/eerie/data/surface_wind/surface_wind_0125.zarr')

# ds['time'] = ds['time'] + pd.Timedelta('12h') # gpm is defined at 00:00, need it at 12:00

# ds = gs.lon_180_to_360(ds)
ds = lon_180_to_360(ds)
# winds = lon_180_to_360(winds)
...
tracks2021_SO_10days_10points_Sep = tracks2021_SO_10days_10points.sel(obs=tracks2021_SO_10days_10points['time'] < pd.to_datetime('2021-09-29'))
...
varnames = ['wind_divergence','wind_curl','avg_10ws']

print('Start looping')
eddies_AG = eddytransform.loop_over_eddies(
    ds,
    # tracks2021_SO,
    tracks2021_SO_10days_10points_Sep,
...
#eddies_AG.to_netcdf('/ec/fws5/lb/project/eerie/testing/eddies_gpm_2021_10_10.nc')
